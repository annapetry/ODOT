  ...
  describe "PATCH update" do
    context "with no token found" do
      it "renders the edit page" do
        patch :update, id: 'notfound', user: { password: 'newpassword1', password_conformation: 'newpassword1'}
        expect(response).to render_template('edit')
      end
    ...
    context "with a valid token" do
      ...
      it "updates the user's password" do
        ...
        patch :update, id: user.password_reset_token, user: { password: 'newpassword1', password_conformation: 'newpassword1' }
        user.reload
      ...
      it "redirects to todo_lists page" do
        patch :update, id: user.password_reset_token, user: { password: 'newpassword1', password_conformation: 'newpassword1' }
